...
public class TestGraphBuilding {
    ...
    private static final String OSM_DB_TESTING =
            "../library-sp18/data/testing.osm.xml";
    ...
    public void setUp() throws Exception {
        ...
        //graphTest = new GraphDB(OSM_DB_TESTING);
        initialized = true;
    }
    ...
    public void testNodeCountFullGraph() {
        ...
        System.out.println("number of nodes full: " + numberOfNodes);
    }
    ...
    public void testNodeCountSmall() {
        ...
        System.out.println(graphSmall.count);
